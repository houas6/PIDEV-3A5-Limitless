...
public class MailSender {
     public static void sendMail(utilisateur client ) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "									<table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"\n"
                + "										class=\"row-content stack\" role=\"presentation\"\n"
                + "										style=\"mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color:#a11d1d; color: #000000; width: 650px;\"\n"
                + "										width=\"650\">\n"
                + "										<tbody>\n"
                + "											<tr>\n"
                + "												<td class=\"column column-1\"\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0;  color: white; font-size: 14px; text-align: center; mso-line-height-alt: 75px;\">\n"
                ...
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: start; mso-line-height-alt: 51px;\">\n"
                + "																			<span style=\"font-size:34px;\"><strong><span\n"
                + "																						style=\"font-size:34px;\"><span\n"
                + "																							style=\"color:#826969;font-size:20px;\"> Cher(e) ["+client.getNom()+" "+client.getPrenom()+"]</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#ffffff;\">Nous vous remercions\n"
                + "																				d'avoir choisi Autodoc pour vos besoins en matière de pièces de rechange automobiles.</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#ffffff;\">Nous avons bien reçu votre demande de retour de produit via notre site d'échange,\n"
                + "																				 et nous vous confirmons que votre demande est en cours de traitement.</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#ffffff;\"><br>\n"
                + "																				"+"<br>Date de la demande  : "+Date.valueOf(LocalDate.now())+"<br>Votre demande est valable jusqu'au : "+Date.valueOf(java.time.LocalDate.now().plusDays(15))+"<br> </span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#ffffff;\">Merci encore pour votre confiance en Autodoc, et nous espérons avoir bientôt de vos nouvelles.</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: start;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#ffffff;\"><br>Cordialement.\n"
                + "																				</span></p>\n"
                + "																		<p\n"
        ...
        Message message = prepareMessage(session, myAccountEmail, client.getMail(), mailContent);
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Demande d'echange de produit");
