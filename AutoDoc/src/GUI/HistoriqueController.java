...
public class HistoriqueController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         List<commande> commande = sc.afficherCommands2();// remplace 1 par client.id
...
paneback.getChildren().addAll(label1,  label3, label4, label5, label6, imageView1, imageView2);
