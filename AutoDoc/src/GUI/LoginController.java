        ...
        Utilisateur currentUtilisateur = Auth.signIn(email, password);
            if (currentUtilisateur != null) {
                ...
                if (role.equals("admin")) {
                    try {
                        Parent root = FXMLLoader.load(getClass().getResource("Admin.fxml")); // correction
                    ...
                    try {
                        Parent root = FXMLLoader.load(getClass().getResource("ListReclamation.fxml")); // correction
                        Scene scene = new Scene(root);
                        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                        stage.setScene(scene);
                        stage.show();
