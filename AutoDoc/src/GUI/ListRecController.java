 ...
 * @author asus
 */
public class ListRecController implements Initializable {
    ...
    public void modifier(ActionEvent event) throws ParseException {
        ...
        if (textNom1.getText().isEmpty()| textDescription.getText().isEmpty() | textEtat.getText().isEmpty()){
            alert.setTitle("Reclamation");
        ...
        reclamations r = new reclamations(idRec,listReclamation.getSelectionModel().getSelectedItem().getid_client(),textDescription.getText(),textEtat.getText());
        CrudReclamation crud = new CrudReclamation();
        crud.modifierreclamation(r);
        
        
        try {
            CrudReclamation crud2= new CrudReclamation();
            ObservableList<reclamations> data = FXCollections.observableArrayList(crud2.afficherreclamation());
            System.out.println("///////");
            System.out.println(data);
            System.out.println("///////");
            DescriptionColumn.setCellValueFactory(new PropertyValueFactory<>("description"));
